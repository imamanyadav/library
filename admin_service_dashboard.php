...
<div class="row" style="position:relative;z-index: 0;left: 87px;top: -85px;"><img class="imglogo" src="images/logo.png"> </div>
</div>
            <div class="leftinnerdiv" style="position:relative;top: -103px;">
            ...
            <div class="rightinnerdiv">   
            <div id="addbook" class="innerright portion" style="position:relative;top: -80px;bottom:0px;<?php  if(!empty($_REQUEST['viewid'])){ echo "display:none";} else {echo ""; }?>">
            <Button class="greenbtn" >ADD NEW BOOK</Button>
            <br>
            <form action="addbookserver_page.php" method="post" enctype="multipart/form-data">
            <label style="position:relative; left:-90px;">Book Name :</label><input type="text" name="bookname"style="position:relative;left: -24px;"/>
            </br>
            <label style="position:relative; left:-90px;">Detail :</label><input  type="text" name="bookdetail"/></br>
            <label style="position:relative; left:-90px;">Autor  :</label><input type="text" name="bookaudor"/></br>
            <label style="position:relative; left:-90px;">Publication :</label><input type="text" name="bookpub" style="position:relative;left: -21px;"/></br>
            ...
            <label style="position:relative; left:-90px;">Quantity :</label><input type="number" name="bookquantity" style="position:relative;left: -10px;"/></br>
            <label style="position:relative; left:-73px;">Book Photo :</label><input  type="file" name="bookphoto" style="position:relative;left: -5px;"/></br>
            </br>
